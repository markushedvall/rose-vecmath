...
void expect_float_mat_eq(Mat<float, COLS, ROWS>& m1, Mat<float, COLS, ROWS>& m2) {
...
TEST(Mat, identity) {
  ...
  expect_float_mat_eq(mat33, expected33);
  ...
  expect_float_mat_eq(mat43, expected43);
  ...
  expect_float_mat_eq(mat34, expected34);
}
